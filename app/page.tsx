  ...
  return (
    <main className="relative min-h-screen overflow-hidden bg-slate-950 text-slate-100">
      ...
      <div className="pointer-events-none absolute inset-0">
        ...
        />
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_center,transparent_0%,rgba(2,6,23,.7)_100%)]" />
      </div>
      ...
      <div className="relative mx-auto flex min-h-screen w-full max-w-3xl flex-col items-center justify-center gap-10 px-6 py-20">
        ...
        <header className="text-center">
          <span className="inline-flex items-center gap-2 rounded-full border border-violet-400/30 bg-violet-400/10 px-3 py-1 text-[11px] font-semibold uppercase tracking-widest text-violet-300">
            <Sparkles size={12} />
            FE-AA1 · Frontend AI Engineering
          </span>
          ...
          <div className="flex flex-col items-center gap-7">
            ...
            <div className="grid w-full grid-cols-1 gap-3 sm:grid-cols-3">
              <button
                ...
                className={cn(
                  "inline-flex items-center justify-center gap-2 rounded-xl border border-emerald-400/20 bg-emerald-400/10 px-4 py-2.5 text-sm font-medium text-emerald-300",
                  "transition-colors duration-150 hover:bg-emerald-400/20 hover:border-emerald-400/40",
              ...
              <button
                ...
                className={cn(
                  "inline-flex items-center justify-center gap-2 rounded-xl border border-rose-400/20 bg-rose-400/10 px-4 py-2.5 text-sm font-medium text-rose-300",
                  "transition-colors duration-150 hover:bg-rose-400/20 hover:border-rose-400/40",
              ...
              <button
                ...
                className={cn(
                  "inline-flex items-center justify-center gap-2 rounded-xl border border-white/10 bg-white/[0.05] px-4 py-2.5 text-sm font-medium text-slate-300",
                  "transition-colors duration-150 hover:bg-white/10 hover:border-white/20",
        ...
        <p className="text-center text-xs text-slate-500">
          Hover &amp; focus for lift + glow · animates transform &amp; opacity
          only · interrupts cleanly under rapid clicks · honors{" "}
